...
{
	AddControllerPitchInput(AxisValue * UGameplayStatics::GetWorldDeltaSeconds(this) * RotationSpeed);
}

void AShooterCharacter::LookRight(float AxisValue)
{
	AddControllerYawInput(AxisValue * UGameplayStatics::GetWorldDeltaSeconds(this) * RotationSpeed);
}
